...
L['Selected Icon::Desc'] = "Mostra l'icona selezionata più di recente. La scelta precedente viene ricordata per questa sessione. Trascina qui un oggetto, un incantesimo, una macro o una cavalcatura per usarne l'icona."
