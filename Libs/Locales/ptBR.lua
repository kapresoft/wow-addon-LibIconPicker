...
L['Selected Icon::Desc'] = 'Mostra o ícone selecionado mais recentemente. Sua escolha anterior é lembrada durante esta sessão. Arraste um item, feitiço, macro ou montaria para cá para usar o ícone dele.'
