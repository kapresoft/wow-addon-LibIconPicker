...
L['Selected Icon::Desc'] = 'Shows the most recently selected icon. Your previous choice is remembered for this session. Drag an item, spell, macro, or mount here to use its icon.'
L['All Icons']     = true
L['Items']         = true
L['Spells']        = true
