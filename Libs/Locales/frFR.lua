...
L['Selected Icon::Desc'] = "Affiche l'icône sélectionnée le plus récemment. Votre choix précédent est mémorisé pour cette session. Faites glisser un objet, un sort, une macro ou une monture ici pour utiliser son icône."
